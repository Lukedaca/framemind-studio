...
const translations = {
  cs: {
    ...
    cull_mode_label: "Režim AI kontroly",
    cull_mode_safe: "Safe",
    cull_mode_economy: "Economy",
    cull_mode_safe_desc: "Výchozí. AI vizuálně posoudí každou fotku včetně heuristických rejectů — žádná fotka nevypadne jen kvůli heuristice.",
    cull_mode_economy_warning: "Economy šetří API volání: jisté heuristické rejecty AI přeskočí a ověří jen auditní vzorek (5–20 fotek). Nižší náklady, ale vyšší riziko falešného vyřazení dobré fotky.",
    cull_taste_title: "Osobní vkus",
    cull_taste_learning: "Učí se z ručních Keep/Reject voleb. Data zůstávají jen v tomto prohlížeči.",
    cull_taste_ready: "Profil je aktivní a upravuje skóre i AI hraničních snímků podle tvého stylu.",
    cull_faces: "tváří",
    cull_eyes_closed: "zavřené oči",
    cull_audit_result: "Audit heuristických rejectů — AI by zachránila",
    cull_audit_recommend_safe: "Doporučujeme přepnout na Safe režim a spustit znovu.",
    cull_source_manual: "Ručně",
    cull_source_ai: "AI ověřeno",
    cull_source_heuristic: "Heuristika",
    ...
    cull_remove_confirm_heur: "Odstranit i rejecty označené JEN heuristikou? Tyto fotky neprošly AI ani ručním posouzením — doporučujeme je nejdřív zkontrolovat.",
    cull_remove_undo_hint: "Akci lze vrátit přes Undo.",
    ...
    cull_reason_open_eyes: "Otevřené oči",
    ...
    cull_risk_closed_eyes: "Zavřené oči",
    cull_risk_ai_disagreement: "Rozpor AI a technické kontroly",
  ...
  en: {
    ...
    cull_mode_label: "AI review mode",
    cull_mode_safe: "Safe",
    cull_mode_economy: "Economy",
    cull_mode_safe_desc: "Default. The AI visually reviews every photo including heuristic rejects — no photo is dropped based on heuristics alone.",
    cull_mode_economy_warning: "Economy saves API calls: confident heuristic rejects skip the AI and only an audit sample (5–20 photos) is verified. Lower cost, but higher risk of falsely rejecting a good photo.",
    cull_taste_title: "Personal taste",
    cull_taste_learning: "Learns from manual Keep/Reject choices. Data stays in this browser.",
    cull_taste_ready: "The profile is active and adapts scores and borderline AI calls to your style.",
    cull_faces: "faces",
    cull_eyes_closed: "eyes closed",
    cull_audit_result: "Heuristic reject audit — the AI would rescue",
    cull_audit_recommend_safe: "We recommend switching to Safe mode and re-running.",
    cull_source_manual: "Manual",
    cull_source_ai: "AI reviewed",
    cull_source_heuristic: "Heuristic",
    ...
    cull_remove_confirm_heur: "Also remove rejects flagged ONLY by heuristics? These photos were not reviewed by AI or manually — we recommend checking them first.",
    cull_remove_undo_hint: "This action can be reverted with Undo.",
    ...
    cull_reason_open_eyes: "Eyes open",
    ...
    cull_risk_closed_eyes: "Eyes closed",
    cull_risk_ai_disagreement: "AI and technical check disagree",
